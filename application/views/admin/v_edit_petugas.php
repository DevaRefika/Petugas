...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper">
      ...
      <div class="card-body">
        <form method="POST" action="<?php echo base_url('index.php/petugas/do_update_petugas')?>">
          ...
          <div class="form-group">
            <div class="form-label-group">
              <input type="text" value="<?php echo $nama_petugas?>" id="nama_petugas" name="nama_petugas" placeholder="Nama_petugas" class="form-control" autocomplete="off" required>
          ...
          <div class="form-group">
            <div class="form-label-group">
              <input type="text" value="<?php echo $telp?>" id="telp" name="telp" placeholder="Telp" class="form-control" autocomplete="off" required>
