          ...
          <div class="card-body">
            <div class="table-responsive">
              <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
  <?php foreach($tanggapan as $chart) : ?>
<tr>
<td><?= $chart['nik'] ?></td>
<td><?= $chart['nama'] ?></td>
 <td><?= $chart['tanggal'] ?></td>
...
<td><a href="<?php echo base_url().'index.php/tanggapan/edit_data_tanggapan/'.$chart['id_tanggapan']; ?>">Edit ||</a>
<a href="<?= base_url('index.php/tanggapan/delete_tanggapan/') . $chart['id_tanggapan'] ?>"onclick="return confirm('Hapus Data?');">Hapus</a>
</td>
</tr>
<?php endforeach ?>
                </tbody>
