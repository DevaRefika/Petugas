...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper">
      ...
      <div class="card-body">
        <form method="POST" action="<?php echo base_url('index.php/tanggapan/do_update_tanggapan')?>">
          <div class="form-group">
            <div class="form-label-group">
              <input type="text" value="<?php echo $id_tanggapan?>" id="id_tanggapan" name="id_tanggapan" placeholder="Id_tanggapan" class="form-control" autocomplete="off" readonly required>
          ...
          <div class="form-group">
            <div class="form-label-group">
              <input type="text" value="<?php echo $tanggal?>" id="tanggal" name="tanggal" placeholder="Tanggal" class="form-control" autocomplete="off" readonly required>
              <label for="tanggal">Tanggal</label>
            </div>
          </div>
          <div class="form-group">
            <div class="form-label-group">
              <input type="text" value="<?php echo $tanggapan?>" id="tanggapan" name="tanggapan" placeholder="Tanggapan" class="form-control" autocomplete="off" required>
              <label for="tanggapan">Tanggapan</label>
            </div>
          </div>
          <div class="form-group">
            <div class="form-label-group">
              <input type="text" value="<?php echo $id_petugas?>" id="id_petugas" name="id_petugas" placeholder="Id_petugas" class="form-control" autocomplete="off" readonly required>
