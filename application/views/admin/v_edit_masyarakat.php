...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper">
      ...
      <div class="card-body">
        <form method="POST" action="<?php echo base_url('index.php/masyarakat/do_update_masyarakat')?>">
          ...
          <div class="form-group">
            <div class="form-label-group">
              <input type="text" value="<?php echo $nama?>" id="nama" name="nama" placeholder="Nama" class="form-control" autocomplete="off" required>
