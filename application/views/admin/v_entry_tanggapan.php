...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper">
      ...
      <div class="card-body">
        <form method="POST" action="<?php echo base_url('index.php/tanggapan/proses_registrasi')?>">
          ...
          <div class="form-group">
            <div class="form-label-group">
              <input type="date" value="<?php echo $tanggal?>" id="tanggal" name="tanggal" placeholder="Tanggal" class="form-control" autocomplete="off" readonly required>
              <label for="tanggal">Tanggal</label>
            </div>
          </div>
          <div class="form-group">
            <div class="form-label-group">
              <input type="text" id="tanggapan" name="tanggapan" placeholder="Tanggapan" class="form-control" autocomplete="off" required>
          ...
          <div class="form-group">
            <div class="form-label-group">
              <input type="text" value="<?php echo $this->session->userdata('ses_id');?>" id="id_petugas" name="id_petugas" placeholder="Id_petugas" class="form-control" autocomplete="off" readonly required>
